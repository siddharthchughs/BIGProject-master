...
public class PaymentTaskDataitems {


    public PaymentTaskDataitems(String id, String clientname, String client_address, String client_landmark, String client_contactno, String client_installation) {
        this.id = id;
