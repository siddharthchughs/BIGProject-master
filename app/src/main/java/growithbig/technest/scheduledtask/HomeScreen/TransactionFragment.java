...
import growithbig.technest.scheduledtask.AdapterManager.TransactionAdapter;
...
public class TransactionFragment extends Fragment {
   ...
   @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        reyclerview = (RecyclerView) v.findViewById(R.id.recyclerpaymenttask);
    ...
    public void showData() {
        ...
        TransactionAdapter taskAdapter = new TransactionAdapter(dataModels, getActivity());
